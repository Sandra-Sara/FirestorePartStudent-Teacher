    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        if (userDoc.exists) {
          ...
          } else if (userData['role'] != _selectedRole) {
            setState(() {
              _errorMessage = 'Selected role does not match account. Try ${_selectedRole == 'student' ? 'teacher' : 'student'} role.';
            });
          } else {
          ...
          setState(() {
            _errorMessage = 'Account not found. Please sign up as a $_selectedRole.';
          });
        }
      } catch (e) {
        setState(() {
